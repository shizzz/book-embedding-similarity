...
PREFIX_BUFFER: int = int(os.getenv("PREFIX_BUFFER",15))
SECTIONS_RATIO: float = float(os.getenv("SECTIONS_RATIO",0.6))

ST_MIN_CHARS: int = int(os.getenv("ST_MIN_CHARS",250))
